...
public class UserDAOTest {
	public static void main(String[] args) {
		...
		UserBeans insRec = new UserBeans("tttt", "TEST", "TEST", "TEST", "TEST","TEST", "TEST", "一", "TEST", "TEST", "TEST");
		...
		UserBeans upRec = new UserBeans(insId, "password", "update.png", "更新太郎", "更新社", "コウシン君", "トランプタワー", "更", "更新", "全世界を更新するよ", "更新は任せてくれ");
		if (dao.update(upRec)) {
